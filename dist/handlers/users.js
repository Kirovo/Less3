...
var userRoutes = function (app) {
    app.get('/users', tokenReader_1.default, index);
    app.get('/users/authentificate', authentificate);
    app.get('/users/:id', tokenReader_1.default, show);
    app.post('/users', create); // REQUIREMENT.md ask for a token to creat a user wich is not applicable
    app.delete('/users/delete/:id', tokenReader_1.default, remove);
    app.put('/users/update/:id', tokenReader_1.default, update);
};
...
var update = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, newFirstName, newLastName, user, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = _req.params.id;
                newFirstName = _req.body.newFirstName;
                newLastName = _req.body.newLastName;
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, store.update(id, newFirstName, newLastName)];
            case 2:
                user = _a.sent();
                res.json(user);
                return [3 /*break*/, 4];
...
var authentificate = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, token;
    return __generator(this, function (_a) {
        user = {
            firstname: _req.body.firstname,
