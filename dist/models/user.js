        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("unable get users: " + err_1);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("unable show user " + id + ": " + err_2);
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("unable create user (" + u.firstname + ", " + u.lastname + "): " + err_3);
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    UserStore.prototype.update = function (id, newFirstName, newLastName) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = 'UPDATE users SET firstName = $2, lastName = $3 WHERE id = $1 RETURNING *';
                        return [4 /*yield*/, conn.query(sql, [id, newFirstName, newLastName])];
                    case 2:
                        result = _a.sent();
                        user = result.rows[0];
                        conn.release();
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("unable update user with id = " + id + " : " + err_4);
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_5 = _a.sent();
                        throw new Error("unable delete user with id = " + id + " : " + err_5);
                    case 4: return [2 /*return*/];
                }
            });
        });
