...
var OrderStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = 'SELECT orders.id order_id, orders.status, orders.user_id, users.firstName, users.lastName FROM orders INNER JOIN users ON orders.user_id = users.id ORDER BY orders.user_id ASC;';
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("unable get orders: " + err_1);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = 'SELECT orders.id order_id, orders.status, orders.user_id, users.firstName, users.lastName FROM orders INNER JOIN users ON orders.user_id = users.id WHERE orders.id=$1';
                        return [4 /*yield*/, database_1.default.connect()];
                    case 1:
                        conn = _a.sent();
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("unable show order " + id + ": " + err_2);
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("unable create order of user (" + o.user_id + "): " + err_3);
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    OrderStore.prototype.addProducts = function (order_id, product_id, quantity) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("unable create order ID (" + order_id + "): " + err_4);
                    case 4: return [2 /*return*/];
                }
            });
        });
